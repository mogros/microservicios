...
public class CommonServiceImpl<E, R extends CrudRepository<E, Long> & PagingAndSortingRepository<E, Long>> 
				implements CommonService<E> {
//public class CommonServiceImpl<E, R extends PagingAndSortingRepository<E, Long>> implements CommonService<E> {
	
	
	@Autowired
	protected R repository;				//para que s epueda utilizar en las clases hijas
